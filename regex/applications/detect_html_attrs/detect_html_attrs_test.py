import unittest, detect_html_attrs


class TestDetectHtmlAttrs(unittest.TestCase):
  def test_detect_html_attrs(self):
    self.assertEqual(
        detect_html_attrs.detect_html_attrs(
...
p:''')
  ...
  def test_detect_html_attrs_1(self):
    self.assertEqual(
        detect_html_attrs.detect_html_attrs(
...
</div>'''), '''a:href,hreflang,lang,title
b:
div:class,id,role
h3:
li:class
